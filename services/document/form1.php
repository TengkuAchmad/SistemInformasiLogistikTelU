    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <?php } else { ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="../process.php" method="POST" id="form-1">
                            <div class="mb-3">
                                <label for="inputNomorSurat" class="form-label">Nomor Surat</label>
                                <input type="text" id="inputNomorSurat" class="form-control" name="NomorSuratInput" placeholder="Cth. SDM_6712039">
                            </div>
                            <div class="mb-3">
                                <label for="inputTanggal" class="form-label">Tanggal Berita Acara</label>
                                <input type="date" id="inputTanggal" class="form-control" name="TanggalInput">
                            </div>
                            <input type="hidden" name="form-control" value="1">
                            <button id="LoadingSimpan" class="btn btn-danger" style="width:100%">Simpan</button>
                        </form>
                    </div>
                </div>
        </div>
