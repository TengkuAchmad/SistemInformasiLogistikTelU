...
$UIDInput1  = uniqid("SIGN_PENGIRIM", true);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <?php } else { ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="../process.php" method="POST" id="form-3">
                            <div class="mb-3">
                                <label for="inputNamaPengirim" class="form-label">Nama Pengirim</label>
                                <input type="text" id="inputNamaPengirim" class="form-control" name="NamaPengirimInput" placeholder="Cth. Imam Sudrajat">
                            </div>
                            <div class="mb-3">
                                <label for="inputInstitusiPengirim" class="form-label">Asal Institusi Pihak Pengirim</label>
                                <input type="text" class="form-control" id="inputInstitusiPengirim" name="InstitusiPengirimInput" placeholder="Cth. Unit SDM">
                            </div>
                            <!-- TANDA TANGAN PENGIRIM -->
                            <div class="mb-1">
                                Form Tanda Tangan Pengirim
                            </div>
                            <div id="sig"></div>
                            <textarea id="signature64" name="signed1" style="display: none"></textarea>
                            <div class="mt-2 mb-3">
                                <input type="hidden" value="<?php echo $UIDInput1 ?>" name="UIDInput1">
                                <button id="clear" class="btn btn-warning">Clear Signature</button>
                            </div>
                            <?php if (isset($_GET['status'])) { ?>
                                <input type="hidden" name="form-control" value="3-1">
                            <?php } else { ?>
                                <input type="hidden" name="form-control" value="3">
                            <?php } ?>
        ...
        <script type="text/javascript">
            ...
            $('#ButtonFormSubmit').click(function(e) {
                alert("Data Pengirim berhasil disimpan!");
            });
        </script>
    <?php } ?>
    </div>
